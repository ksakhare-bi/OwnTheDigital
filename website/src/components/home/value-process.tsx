...
export function WhyHireUsSection() {
  return (
    <section className="mx-auto max-w-[1392px] px-4 py-12 sm:px-6 sm:py-24 lg:py-32">
      ...
      <div className="mt-8 grid gap-4 sm:mt-16 sm:gap-6 lg:grid-cols-3 lg:gap-9">
          ...
          >
            <CardContent className="flex h-full flex-col p-5 sm:p-10 lg:px-[31px] lg:py-[45px]">
              ...
              <div className="mt-6 sm:mt-20">
                <h3 className="max-w-64 text-[28px] leading-none font-bold tracking-[0.03em] text-navy sm:text-5xl">
                  {advantage.title}
                </h3>
              ...
              <Badge className="mt-6 h-auto w-fit max-w-full rounded-full border border-border bg-surface-tint px-3 py-2 text-left text-xs leading-4 font-bold whitespace-normal text-success uppercase hover:bg-surface-tint sm:mt-auto sm:px-4 sm:py-3 sm:text-sm sm:leading-5">
                {advantage.result}
              </Badge>
            </CardContent>
          </Card>
...
export function ProcessSection() {
  return (
    <section className="mx-auto max-w-[1392px] px-4 py-12 sm:px-6 sm:py-24 lg:py-32">
      ...
      <div className="relative mt-8 grid grid-cols-2 gap-x-3 gap-y-8 sm:mt-16 sm:gap-12 md:grid-cols-2 lg:grid-cols-4 lg:gap-0">
        <div
          aria-hidden="true"
